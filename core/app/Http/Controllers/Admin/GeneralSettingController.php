...
$general->sec_cur_text                  = $request->sec_cur_text;
$general->sec_cur_sym                   = $request->sec_cur_sym;
$general->bal_trans_fixed_charge    = $request->bal_trans_fixed_charge;
$general->bal_trans_per_charge      = $request->bal_trans_per_charge;
$general->coin_commission           = $request->coin_commission;
$general->coin_daily                = $request->coin_daily;
$general->coin_multiple             = $request->coin_multiple;
$general->coin_limit                = $request->coin_limit;
...
$general->cryp_widget               = $request->cryp_widget? 1 : 0;
$general->cryp_calculator           = $request->cryp_calculator? 1 : 0;
$general->profit_status           = $request->profit? 1 : 0;
$general->reward_status           = $request->reward? 1 : 0;
$general->save();
