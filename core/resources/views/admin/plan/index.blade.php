                        ...
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col">@lang('Direct Referral Commission')</th>
                                    <th scope="col">@lang('Indirect Referral Commission')</th>
                            ...
                            <tbody>
                                @forelse($plans as $key => $plan)
                                    <tr>
                                        ...
                                        <td data-label="@lang('Min Price')">{{ getAmount($plan->min_price) }}
                                            {{ $general->cur_text }}</td>
                                        <td data-label="@lang('Max Price')">{{ getAmount($plan->max_price) }}
                                            {{ $general->cur_text }}</td>
                                        <td data-label="@lang('Direct Referral Commission')"> {{ $plan->ref_com }} %</td>
                                        <td data-label="@lang('Indirect Referral Commission')"> {{ $plan->indir_com }} %</td>
                                        <td data-label="@lang('Profit')">{{ $plan->profit }} %</td>
                                        <td data-label="@lang('Is default')">
                                            @if ($plan->is_default == 1)
                                                <span
                                                    class="text--small badge font-weight-normal badge--primary">@lang('Default')</span>
                                            @endif
                                        </td>
                                        ...
                                        <td data-label="@lang('Action')">
                                            <button type="button" class="icon-btn edit" data-toggle="tooltip"
                                                ...
                                                data-status="{{ $plan->status }}" data-isdefault="{{ $plan->is_default }}"
                                                data-minprice="{{ getAmount($plan->min_price) }}"
                                                data-maxprice="{{ getAmount($plan->max_price) }}"
                                                data-ref_com="{{ $plan->ref_com }}"
                                                data-indir_com="{{ $plan->indir_com }}" data-profit="{{ $plan->profit }}"
                ...
                <form method="post" action="{{ route('admin.plan.update') }}">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                <label class="font-weight-bold">@lang('Direct Referral Commission')</label>
                                <div class="input-group">
                            ...
                            <div class="form-group col-md-6">
                                <label class="font-weight-bold">@lang('Indirect Referral Commission')</label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text">%</span></div>
                                    <input type="number" step="0.01" min="0" max="100"
