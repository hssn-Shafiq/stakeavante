                ...
                <div class="card border--dark mt-3">
                    ...
                    <div class="card-body">
                        <div class="row addedField">
                             <span>@lang('Use word "transaction id" if you want to add transaction id and select type input text.Marke it required.')</span>
                        </div>
                    </div>
                </div>
            </div>
...
<a href="{{ route('admin.gateway.manual.index') }}" class="btn btn-sm btn--dark box--shadow1 text--small"><i class="la la-fw la-backward"></i> @lang('Go Back') </a>
@endpush
