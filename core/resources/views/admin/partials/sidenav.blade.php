...
<li class="sidebar-menu-item {{menuActive('admin.membership*')}}">
            <a href="{{route('admin.membership')}}" class="nav-link ">
                <i class="menu-icon las la-cogs"></i>
                <span class="menu-title">@lang('Memberships')</span>
            </a>
        </li>
<li class="sidebar-menu-item {{menuActive('admin.rewards*')}}">
            <a href="{{route('admin.rewards')}}" class="nav-link ">
                <i class="menu-icon las la-paper-plane"></i>
...
<li class="sidebar-menu-item sidebar-dropdown">
    ...
    <div class="sidebar-submenu {{menuActive('admin.users*',2)}} ">
        <ul>
            ...
            <li class="sidebar-menu-item {{menuActive('admin.users.winner')}} ">
                <a href="{{route('admin.users.winner')}}" class="nav-link">
                    <i class="menu-icon las la-dot-circle"></i>
                    <span class="menu-title">@lang('Winner Users')</span>
                </a>
            </li>
            ...
            <li class="sidebar-menu-item {{menuActive('admin.users.unpaid')}} ">
                <a href="{{route('admin.users.unpaid')}}" class="nav-link">
                    <i class="menu-icon las la-dot-circle"></i>
                    <span class="menu-title">@lang('Un Paid Users')</span>
                </a>
            </li>
            ...
            <li class="sidebar-menu-item {{menuActive('admin.users.sale-defected')}} ">
                <a href="{{route('admin.users.sale-defected')}}" class="nav-link">
                    <i class="menu-icon las la-dot-circle"></i>
                    <span class="menu-title">@lang('Sale Defected Users')</span>
                </a>
            </li>
...
<li class="sidebar-menu-item {{menuActive('admin.frontend.manage-menu*')}}">
    <a href="{{route('admin.frontend.manage-menu')}}" class="nav-link ">
        <i class="menu-icon la la-book"></i>
        <span class="menu-title">@lang('Manage Menu')</span>
    </a>
</li>
<li class="sidebar-menu-item sidebar-dropdown">
