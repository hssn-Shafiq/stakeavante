                            ...
                            <div class="payment-method-header d-flex flex-wrap">
                                <div class="thumb">
                                    <div class="avatar-preview">
                                        <div class="profilePicPreview" style="background-image: url('{{getImage(imagePath()['withdraw']['method']['path'],imagePath()['withdraw']['method']['size'])}}')"></div>
                                    </div>
...
@push('breadcrumb-plugins')
    <a href="{{ route('admin.withdraw.method.index') }}" class="btn btn-sm btn--dark box--shadow1 text--small">
