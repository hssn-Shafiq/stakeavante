        ...
        <div class="col-lg-12 col-sm-6 mb-10">
                <div class="card border--light">
                    <div class="card-body">
                        ...
                        <img id="output" src="{{ getImage('assets/images/user/awards/reward1-main.png',  null, true)}}" alt="@lang('reward-1-image')" class="img-responsive b-radius--10" title="Team Leader Achieved" style="width:10%;">
                        @endif
                        @if(auth()->user()->reward_two==1)
                        <img id="output" src="{{ getImage('assets/images/user/awards/reward2-main.png',  null, true)}}" alt="@lang('reward-2-image')" class="img-responsive b-radius--10" title="Region Leader Achieved" style="width:10%;">
                        @endif
                        @if(auth()->user()->reward_three==1)
                        <img id="output" src="{{ getImage('assets/images/user/awards/reward3-main.png',  null, true)}}" alt="@lang('reward-3-image')" class="img-responsive b-radius--10" title="National Leader Achieved" style="width:10%;">
                        @endif
                        @if(auth()->user()->reward_four==1)
                        <img id="output" src="{{ getImage('assets/images/user/awards/reward4-main.png',  null, true)}}" alt="@lang('reward-4-image')" class="img-responsive b-radius--10" title="Royal Leader Achieved" style="width:10%;">
                        @endif
                        @if(auth()->user()->reward_five==1)
                        <img id="output" src="{{ getImage('assets/images/user/awards/reward5-main.png',  null, true)}}" alt="@lang('reward-5-image')" class="img-responsive b-radius--10" title="Crown Leader Achieved" style="width:10%;">
                        @endif
                        @if(auth()->user()->reward_six==1)
                        <img id="output" src="{{ getImage('assets/images/user/awards/reward6-main.png',  null, true)}}" alt="@lang('reward-6-image')" class="img-responsive b-radius--10" title="Diamond Leader Achieved" style="width:10%;">
                        @endif
                        @if(auth()->user()->reward_seven==1)
                        <img id="output" src="{{ getImage('assets/images/user/awards/reward7-main.png',  null, true)}}" alt="@lang('reward-7-image')" class="img-responsive b-radius--10" title="Avante Leader Achieved" style="width:10%;">
                        @endif
                        </div>
                    </div>
                </div>
                ...
                <div class="card border--light">
                    <div class="card-header">@lang('Notice Board')
                        ...
                        <h4 class="text-danger" style="font-family:Cursive;">
                            @if(auth()->user()->plan_id < 1)@lang('Your Staking plan is expired on '){{auth()->user()->plan_expiry}}
                            @else
