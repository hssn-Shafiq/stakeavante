                ...
                <div class="w-100">
                    ...
                    <form class="account--form row g-4" method="post" action="{{route('user.login')}}"
                        ...
                        <div class="col-sm-12">
                            ...
                            <label for="username" class="form--label-2">@lang('Avante ID')</label>

                            <input type="text" id="username" name="username" value="{{old('username')}}" placeholder="@lang('Avante ID')" required class="form-control form--control-2">
