            ...
            <div class="col-xs-12 col-sm-12 col-md-6 countdown-wrapper text-center mb20">
                <div class="card">
                    ...
                    <div class="card-block">
                        <div id="countdown">
                            <div class="well">
                                <span id="freeaxt" class="timer bg-warning">{{auth()->user()->free_coins}}</span>
                            </div>
                        </div>
                    </div>
                ...
                <div class="card">
                    ...
                    <div class="card-footer">
                       <div class="col-md-12">
                        ...
                        <a href="{{asset('assets/documents/presentation_01.pdf')}}" class="btn btn--primary">Presentation</a>
                    </div>
                    </div>
                    @else
                    <div class="card-header">
