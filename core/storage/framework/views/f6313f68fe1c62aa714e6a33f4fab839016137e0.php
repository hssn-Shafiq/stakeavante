            ...
            <div class="dashboard-w1 bg--success b-radius--10 box-shadow has--link">
                ...
                <div class="details">
                    ...
                    <div class="desciption">
                        <span class="text--small"><?php echo app('translator')->get('Current Balance'); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make($activeTemplate . 'user.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ki11859513/stakeavante.com/core/resources/views/templates/basic/user/dashboard.blade.php ENDPATH**/ ?>