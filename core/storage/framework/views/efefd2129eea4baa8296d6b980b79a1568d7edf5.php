        ...
        <div class="col-lg-12">
            <div class="card">
                <form action="<?php echo e(route('admin.withdraw.method.update', $method->id)); ?>" method="POST"
                    ...
                    <?php echo csrf_field(); ?>
                    <div class="card-body">
                        <h6 class="card-title mb-20"><?php echo app('translator')->get('Method Update Form'); ?></h6>
                            ...
                            <div class="payment-method-header d-flex flex-wrap">
                                ...
                                <div class="content">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" name="name" value="<?php echo e($method->name); ?>"/>
                                    </div>
                                    <div class="row mt-4">
                                        <div class="col-md-4">
                                            <div class="form-group">
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ki11859513/stakeavante.com/core/resources/views/admin/withdraw/edit.blade.php ENDPATH**/ ?>