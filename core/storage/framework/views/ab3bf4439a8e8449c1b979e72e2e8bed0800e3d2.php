                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light">
                            ...
                            <tr>
                                ...
                                <th scope="col"><?php echo app('translator')->get('Submitted By'); ?></th>
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $items; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    <td data-label="<?php echo app('translator')->get('Subject'); ?>">
                                        <a href="<?php echo e(route('admin.ticket.view', $item->id)); ?>" class="font-weight-bold"> [Ticket#<?php echo e($item->ticket); ?>] <?php echo e($item->subject); ?> </a>
                                    </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ki11859513/stakeavante.com/core/resources/views/admin/support/tickets.blade.php ENDPATH**/ ?>