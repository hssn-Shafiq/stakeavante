                        ...
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    ...
                                    <th scope="col"><?php echo app('translator')->get('Direct Referral Commission'); ?></th>
                                    <th scope="col"><?php echo app('translator')->get('Indirect Referral Commission'); ?></th>
                            ...
                            <tbody>
                                <?php $__empty_1 = true; $__currentLoopData = $plans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $plan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td data-label="<?php echo app('translator')->get('Min Price'); ?>"><?php echo e(getAmount($plan->min_price)); ?>

                                            <?php echo e($general->cur_text); ?></td>
                                        <td data-label="<?php echo app('translator')->get('Max Price'); ?>"><?php echo e(getAmount($plan->max_price)); ?>

                                            <?php echo e($general->cur_text); ?></td>
                                        <td data-label="<?php echo app('translator')->get('Direct Referral Commission'); ?>"> <?php echo e($plan->ref_com); ?> %</td>
                                        <td data-label="<?php echo app('translator')->get('Indirect Referral Commission'); ?>"> <?php echo e($plan->indir_com); ?> %</td>
                                        <td data-label="<?php echo app('translator')->get('Profit'); ?>"><?php echo e($plan->profit); ?> %</td>
                                        <td data-label="<?php echo app('translator')->get('Is default'); ?>">
                                            <?php if($plan->is_default == 1): ?>
                                                <span
                                                    class="text--small badge font-weight-normal badge--primary"><?php echo app('translator')->get('Default'); ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <td data-label="<?php echo app('translator')->get('Status'); ?>">
                                            ...
                                            <?php else: ?>
                                                <span
                                                    class="text--small badge font-weight-normal badge--danger"><?php echo app('translator')->get('Inactive'); ?></span>
                                            <?php endif; ?>
                                        </td>
                                        <td data-label="<?php echo app('translator')->get('Action'); ?>">
                                            <button type="button" class="icon-btn edit" data-toggle="tooltip"
                                                data-id="<?php echo e($plan->id); ?>" data-name="<?php echo e($plan->name); ?>"
                                                data-status="<?php echo e($plan->status); ?>" data-isdefault="<?php echo e($plan->is_default); ?>"
                                                ...
                                                data-indir_com="<?php echo e($plan->indir_com); ?>" data-profit="<?php echo e($plan->profit); ?>"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="number" step="0.01" min="0" class="form-control minprice"
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span
                                            class="input-group-text"><?php echo e($general->cur_sym); ?></span></div>
                                    <input type="number" step="0.01" min="0" class="form-control maxprice"
                                        name="maxprice" required>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="font-weight-bold"><?php echo app('translator')->get('Direct Referral Commission'); ?></label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text">%</span></div>
                                    <input type="number" step="0.01" min="0" max="100"
                                        class="form-control ref_com" name="ref_com" required>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="font-weight-bold"><?php echo app('translator')->get('Indirect Referral Commission'); ?></label>
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text">%</span></div>
                                    <input type="number" step="0.01" min="0" max="100"
                                        class="form-control indir_com" name="indir_com" required>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text">%</span></div>
                                    <input type="number" step="0.01" min="0" class="form-control profit"
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-12">
                                ...
                                <input type="checkbox" data-width="100%" data-onstyle="-success" data-offstyle="-danger"
                                    data-toggle="toggle" data-on="<?php echo app('translator')->get('Active'); ?>" data-off="<?php echo app('translator')->get('Inactive'); ?>"
                                    name="status" checked>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    <div class="input-group-prepend"><span class="input-group-text">%</span></div>
                                    <input type="number" step="0.01" min="0" max="100"
                                        class="form-control" name="indir_com" required>
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <label class="font-weight-bold"><?php echo app('translator')->get('Profit'); ?></label>
...
<?php $__env->startPush('breadcrumb-plugins'); ?>
    <a href="javascript:void(0)" class="btn btn-sm btn--success add-plan"><i
            class="fa fa-fw fa-plus"></i><?php echo app('translator')->get('Add New'); ?></a>
<?php $__env->stopPush(); ?>
    ...
    <script>
        ...
        (function($) {
            $('.edit').on('click', function() {
                ...
                modal.find('.indir_com').val($(this).data('indir_com'));
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\techSphereLogix\stakeavante\core\resources\views/admin/plan/index.blade.php ENDPATH**/ ?>