        ...
        <div class="row">
            <div class="col-xs-12 col-sm-12 col-md-6 countdown-wrapper text-center mb20">
                <div class="card">
                    ...
                    <div class="card-footer">
                        ...
                        <p><span class="fa fa-arrow-right"></span> You must have <?php echo e($general->coin_limit); ?> USDT.</p>
                        <p><span class="fa fa-arrow-right"></span> You must have followed all social links in the popup.</p>
                        <p><span class="fa fa-arrow-right"></span> You can increase daily reward as below.</br><span  class="badge rounded-pill bg-success">Day 1st <?php echo e(($general->coin_daily+(0*$general->coin_multiple))); ?> USDT</span><span  class="badge rounded-pill bg-primary">Day 2nd <?php echo e(($general->coin_daily+(1*$general->coin_multiple))); ?> USDT</span><span  class="badge rounded-pill bg-info">Day 3rd <?php echo e(($general->coin_daily+(2*$general->coin_multiple))); ?> USDT</span><span  class="badge rounded-pill bg-success">Day 4th <?php echo e(($general->coin_daily+(3*$general->coin_multiple))); ?> USDT</span><span  class="badge rounded-pill bg-primary">Day 5th <?php echo e(($general->coin_daily+(4*$general->coin_multiple))); ?> USDT</span><span  class="badge rounded-pill bg-info">Day 6th <?php echo e(($general->coin_daily+(5*$general->coin_multiple))); ?> USDT</span><span  class="badge rounded-pill bg-danger">Day 7th <?php echo e(($general->coin_daily+(6*$general->coin_multiple))); ?> USDT</span>
                        </p>
            ...
            <div class="col-xs-12 col-sm-12 col-md-6 countdown-wrapper text-center mb20">
                <div class="card">
                    ...
                    <div class="card-block">
                         <a href="<?php echo e(route('user.free-coins')); ?>" class="btn btn-info">Claim Free USDT Now</a>
                    </div>
                    <div class="card-footer">
                       <div class="col-md-12">
                        <!-- Facebook -->
...
<?php $__env->stopPush(); ?>
<?php /**PATH /home/ki11859513/stakeavante.com/core/resources/views/templates/basic/user/partials/countdown.blade.php ENDPATH**/ ?>