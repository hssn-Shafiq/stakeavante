            ...
            <li class="dropdown">
                <button type="button" class="" data-toggle="dropdown" data-display="static" aria-haspopup="true" aria-expanded="false">
                    ...
                    <span class="navbar-user">
                        <span class="navbar-user__thumb"><img src="<?php echo e(getImage('assets/admin/images/profile/'. auth()->guard('admin')->user()->image)); ?>" alt="<?php echo app('translator')->get('image'); ?>"></span>
...
<!-- navbar-wrapper end -->
<?php /**PATH C:\laragon\www\techSphereLogix\stakeavante\core\resources\views/admin/partials/topnav.blade.php ENDPATH**/ ?>