                                        ...
                                        <?php $__currentLoopData = $item; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $imgKey => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <div class="col-md-4">
                                                ...
                                                <div class="form-group">
                                                    <label><?php echo e(inputTitle($imgKey)); ?></label>
                                                        ...
                                                        <div class="thumb">
                                                            <div class="avatar-preview">
                                                                <div class="profilePicPreview"
                                                                     ...
                                                                     style="background-image: url(<?php echo e(getImage('assets/images/frontend/' . $key .'/'. @$content->data_values->$imgKey,@$section->content->images->$imgKey->size)); ?>)">
                                                            ...
                                                            <div class="avatar-edit">
                                                                ...
                                                                <label for="profilePicUpload<?php echo e($loop->index); ?>"
                                                                       class="bg--primary"><?php echo e(inputTitle($imgKey)); ?></label>
                                                                <small class="mt-2 text-facebook"><?php echo app('translator')->get('Supported files:'); ?> <b>jpeg, jpg, png</b>.
                                    ...
                                    <?php else: ?>
                                        <?php if($k != 'images'): ?>
                                            <?php if($item == 'icon'): ?>
                                                <div class="col-md-12">
                                                    <div class="form-group ">
                                                        <label class="form-control-label font-weight-bold"><?php echo e(inputTitle($k)); ?></label>
                                            ...
                                            <?php elseif($item == 'textarea'): ?>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label  font-weight-bold"><?php echo e(inputTitle($k)); ?></label>
                                                        <textarea rows="10" class="form-control" placeholder="<?php echo e(inputTitle($k)); ?>" name="<?php echo e($k); ?>" required><?php echo e(@$content->data_values->$k); ?></textarea>
                                                    </div>
                                                </div>
                                            ...
                                            <?php elseif($item == 'textarea-nic'): ?>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label  font-weight-bold"><?php echo e(inputTitle($k)); ?></label>
                                                        <textarea rows="10" class="form-control nicEdit" placeholder="<?php echo e(inputTitle($k)); ?>" name="<?php echo e($k); ?>" ><?php echo e(@$content->data_values->$k); ?></textarea>
                                                    </div>
                                                </div>
                                            <?php elseif($k == 'select'): ?>
                                                <?php
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label  font-weight-bold"><?php echo e(inputTitle(@$selectName)); ?></label>
                                            ...
                                            <?php else: ?>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label class="form-control-label  font-weight-bold"><?php echo e(inputTitle($k)); ?></label>
                                                        <input type="text" class="form-control" placeholder="<?php echo e(inputTitle($k)); ?>" name="<?php echo e($k); ?>" value="<?php echo e(@$content->data_values->$k); ?>" required/>
                                                    </div>
                                                </div>
                                ...
                                <?php $__currentLoopData = $section->element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php if($k !='modal'): ?>
                                        <?php if($type=='text' || $type=='icon'): ?>
                                            <th scope="col"><?php echo e(__(inputTitle($k))); ?></th>
                                        <?php elseif($k == 'select'): ?>
                                            <th scope="col"><?php echo e(inputTitle(@$section->element->$k->name)); ?></th>
                                        <?php endif; ?>
                                    <?php endif; ?>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <?php $__currentLoopData = $section->element; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $k => $type): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($k !='modal'): ?>
                                            ...
                                            <?php elseif($k == 'select'): ?>
                                                ...
                                                ?>
                                                <td data-label="<?php echo e(__(inputTitle(@$section->element->$k->name))); ?>"><?php echo e(@$data->data_values->$dataVal); ?></td>
                                            <?php endif; ?>
                                        <?php endif; ?>
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
            ...
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <form action="<?php echo e(route('admin.frontend.remove')); ?>" method="POST">
                        ...
                        <div class="modal-body">
                            <p class="font-weight-bold"><?php echo app('translator')->get('Are you sure you want to delete this item? Once deleted can not be undo this action.'); ?></p>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn--dark" data-dismiss="modal"><?php echo app('translator')->get('Close'); ?></button>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/ki11859513/stakeavante.com/core/resources/views/admin/frontend/index.blade.php ENDPATH**/ ?>