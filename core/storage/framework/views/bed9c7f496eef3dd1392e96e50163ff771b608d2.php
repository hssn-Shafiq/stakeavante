                        ...
                        <table class="table table--light style--two">
                            ...
                            <?php $__empty_1 = true; $__currentLoopData = $transactions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $trx): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr>
                                    ...
                                    <td data-label="<?php echo app('translator')->get('Username'); ?>"><a href="<?php echo e(route('admin.users.detail', $trx->user_id)); ?>"><?php echo e(@$trx->user->username); ?></a></td>
                                    ...
                                    <td data-label="<?php echo app('translator')->get('Charge'); ?>" class="budget"><?php echo e($general->cur_sym); ?> <?php echo e(getAmount($trx->charge)); ?> </td>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\techSphereLogix\stakeavante\core\resources\views/admin/reports/transactions.blade.php ENDPATH**/ ?>