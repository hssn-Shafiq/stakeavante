    ...
    <div class="page-wrapper default-version">
        <div class="form-area bg_img" data-background="<?php echo e(asset('assets/admin/images/1.jpg')); ?>">
            <div class="form-wrapper">
                ...
                <p><?php echo e(__($page_title)); ?> <?php echo app('translator')->get('to'); ?>  <?php echo e(__($general->sitename)); ?> <?php echo app('translator')->get('dashboard'); ?></p>
...
<?php echo $__env->make('admin.layouts.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\techSphereLogix\stakeavante\core\resources\views/admin/auth/login.blade.php ENDPATH**/ ?>