...
|--------------------------------------------------------------------------
*/
Route::get('/give-rewards', 'CronController@giveRewards')->name('give-rewards');
Route::get('/give-profit', 'CronController@giveProfit')->name('give-profit');
Route::get('/delete-expires', 'CronController@deleteUnpaid')->name('delete-expires');
Route::get('/make-expires', 'CronController@makeExpire')->name('make-expires');
Route::namespace('Api')->prefix('api')->name('api.')->group(function () {
Route::get('/verify-user-info', 'UserRequestApi@getUserInfo')->name('verify-user-info');
});
// User Support Ticket
...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        // manage plan
        Route::get('plans', 'ManagePlanController@plan')->name('plan');
        Route::post('plan/store', 'ManagePlanController@planStore')->name('plan.store');

        Route::post('plan/update', 'ManagePlanController@planUpdate')->name('plan.update');
        // manage Memebership
        Route::get('membership', 'ManagePlanController@membership')->name('membership');
        Route::post('membership/update', 'ManagePlanController@membershipUpdate')->name('membership.update');
        // manage Rewards
        Route::get('rewards', 'ManagePlanController@rewards')->name('rewards');
        Route::post('rewards/update', 'ManagePlanController@rewardsUpdate')->name('rewards.update');
        ...
        Route::get('users/sale-defected', 'ManageUsersController@saleDefUsers')->name('users.sale-defected');
        Route::get('users/sale-fix/{id}', 'ManageUsersController@saleFix')->name('users.sale-fix');
        Route::get('users/winner', 'ManageUsersController@winnerUsers')->name('users.winner');
        Route::get('users/active', 'ManageUsersController@activeUsers')->name('users.active');
        Route::get('users/banned', 'ManageUsersController@bannedUsers')->name('users.banned');
        Route::get('users/unpaid', 'ManageUsersController@unpaidUsers')->name('users.unpaid');
        ...
        Route::get('report/binary-summery', 'ReportController@binarySummery')->name('report.binarySummery');
        ...
        Route::name('frontend.')->prefix('frontend')->group(function () {
            ...
            // Page Builder
        Route::get('manage-menu', 'PageBuilderController@allMenu')->name('manage-menu');
        Route::post('manage-menu/add', 'PageBuilderController@addMenu')->name('manage-menu.add');
        Route::post('manage-menu/update', 'PageBuilderController@updateMenu')->name('manage-menu.update');
...
Route::name('user.')->prefix('user')->group(function () {
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware(['checkStatus'])->group(function () {
            ...
            Route::post('/social-count', 'UserController@socialCount')->name('social-count');
            Route::get('/free-coins', 'UserController@freeCoins')->name('free-coins');
            ...
            Route::post('/plan/restake', 'PlanController@planMore')->name('plan.restake');
            // Deposit
    ...
    Route::middleware(['ensurePayment'])->group(function () {
            ...
            Route::get('report/binary-summery', 'UserReportController@binarySummery')->name('report.binarySummery');
